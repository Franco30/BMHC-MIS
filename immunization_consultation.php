...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Immunization Consultation / <?php echo $fetch['child_name']?></strong></h3>
                            ...
                            <div class="panel-body">
                                <?php require 'tables/immunization_consultation_table.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php require 'modals/add_immunization_consultation.php'; ?>
    <!-- END PAGE CONTENT -->
    <audio id="audio-alert" src="audio/alert.mp3" preload="auto"></audio>
    <audio id="audio-fail" src="audio/fail.mp3" preload="auto"></audio>
    <script type="text/javascript" src="js/plugins/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="functions/crudimmunizationconsultation.js"></script>
