<div class="yearly baryear splineyear pieyear dougnutyear reporttype" style="display: none;">
    ...
    <table id="fptable" class="table table-bordered table-condensed nowrap" width="100%">
        <thead>
            <tr class="warning">
                <th>Year</th>
                <th>Total Count</th>
        ...
        <tbody>
            ...
            $query = $conn->query("SELECT year, count(*) as count FROM `family_planning` group by year order by count DESC") or die(mysqli_error());
