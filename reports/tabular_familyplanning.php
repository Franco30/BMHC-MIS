<div class="modal fade" id="jan" tabindex="-1" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
                    ...
                    <table class="table datatable">
                        <thead>
                            <tr class="warning">
                                ...
                                <th><center>Family Planning Date</center></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
    ...
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Jan' && `year` = '$year'") or die(mysqli_error());
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Feb' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Mar' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'April' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'May' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Jun' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Jul' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Aug' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Sep' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Oct' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Nov' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `family_planning` WHERE `month` = 'Dec' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $id = $fetch2['patient_id'];
                        $query = $conn->query("SELECT  `patient_name`, `patient_id` FROM `patient` WHERE `patient_id` = '$id' ORDER BY `patient_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
