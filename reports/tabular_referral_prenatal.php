        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel-body">
                    ...
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Jan' && `year` = '$year'") or die(mysqli_error());
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Feb' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Mar' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'April' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'May' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Jun' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Jul' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Aug' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Sep' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Oct' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Nov' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                ...
                <div class="panel-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
    require 'require/config.php';
                    $query2 = $conn->query("SELECT * FROM `referral_prenatal` WHERE `month` = 'Dec' && `year` = '$year'") or die(mysqli_error());
                    while($fetch2 = $query2->fetch_array()){
                        $query = $conn->query("SELECT  * FROM `referral_prenatal`  ORDER BY `referral_id` DESC") or die(mysqli_error());
                        $fetch = $query->fetch_array();
                            ?>
