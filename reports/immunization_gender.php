...
$query1 = $conn->query("select count(*) as total from `patient_child`, `immunization` where immunization.child_id = patient_child.child_id && immunization.gender = 'Male' && immunization.year = '$year'") or die(mysqli_error());
$fetch1 = $query1->fetch_array();

$query2 = $conn->query("select count(*) as total from `patient_child`, `immunization` where immunization.child_id = patient_child.child_id && immunization.gender = 'Female' && immunization.year = '$year'") or die(mysqli_error());
$fetch2 = $query2->fetch_array();

$query3 = $conn->query("select count(*) as total from `patient_child`, `immunization` where immunization.child_id = patient_child.child_id && immunization.year = '$year'") or die(mysqli_error());
...
?>
	...
	<table class="table table-condensed">
		<thead>
			<tr class="warning">
				<th><center>Child Patient</center></th>
