<div class="1colpatientgender reporttype" style="display: none;">
	<?php
require 'require/config.php';
$query1 = $conn->query("select count(*) as total from `patient_child` where patient_child.gender = 'Male' && patient_child.year = '$year'") or die(mysqli_error());
$fetch1 = $query1->fetch_array();

$query2 = $conn->query("select count(*) as total from `patient_child` where patient_child.gender = 'Female' && patient_child.year = '$year'") or die(mysqli_error());
$fetch2 = $query2->fetch_array();

$query3 = $conn->query("select count(*) as total from `patient_child` where patient_child.year = '$year'") or die(mysqli_error());
