...
$query1 = $conn->query("select count(*) as total from `patient` where patient.gender = 'Male' && patient.year = '$year'") or die(mysqli_error());
$fetch1 = $query1->fetch_array();

$query2 = $conn->query("select count(*) as total from `patient` where patient.gender = 'Female' && patient.year = '$year'") or die(mysqli_error());
