...
<meta name="theme-color" content="#E91E63" />
    ...
    <?php require 'js/loadcharts/reports/prenatal2.php'?>
    <!-- EOF CSS INCLUDE -->
    <style type="text/css">
        @media print {
/*
    ...
    <div class="page-container page-navigation-top">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb print">
                ...
                <li>Prenatal Reports</li>
                <li class="active"><mark><strong>Prenatal Filtered Reports</strong></mark></li>
            </ul>
            <!-- END BREADCRUMB -->
                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <?php require 'reports/prenatal_monthly.php'?>
    ...
    <script>
        $(document).ready(function() {
            $("#pyear").on('change', function() {
                var year = $(this).val();
                window.location = 'prenatal_filter?year=' + year;
            });
        });
