...
<meta name="theme-color" content="#E91E63" />
    ...
    <?php require 'js/loadcharts/reports/child.php'?>
    <style type="text/css">
        @media print {
/*
            @page {
...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb print">
                <li>Reports</li>
                <li class="active"><strong><mark>Patient Child Report</mark></strong></li>
            </ul>
            <!-- END BREADCRUMB -->
            ...
            ?>
                            ...
                            <div class="panel-body tab-content">
                                                ...
                                                <div class="panel-body panel-body-table">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    require 'chartqueries/child.php';
                                                                ?>
                                                                <tr>
                                ...
                                <div class="tab-pane" id="tab-second">
                                    <div class="row">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Child Patient Date Range Tabular Report</strong></h3>
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <div id="patient_daterange">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody id="load_data">
                                                                    <?php
                                            $query = $conn->query("SELECT * FROM `patient_child` order by `child_id` DESC LIMIT 16") or die(mysqli_error());
                                            while($fetch = $query->fetch_array()){
                                    ?>
                                                                    <tr>
                                                                        <td><strong><center><?php echo $fetch['year']."".$fetch['child_id']?></center></strong></td>
                                ...
                                <div class="tab-pane" id="tab-third">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="panel panel-primary">
                                                <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Individual Child Patient Record</strong></h3>
                                                </div>
                                                <!-- style="height: 470px;"-->
                ...
                <h4>Total Child Patients for the Year <?php echo $year. ' : <strong> ' .$fetch['total'].' Patients</strong>'?></h4> <hr>
    ...
    <script>
        $(document).ready(function() {
            $("#pyear").on('change', function() {
                var year = $(this).val();
                window.location = 'child?year=' + year;
            });
        });
    ...
    <!-- END TEMPLATE -->
    <!-- END SCRIPTS -->
    <?php require 'reports/tabular_child.php'?>
</body>
