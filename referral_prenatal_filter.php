    ...
    <div class="page-container page-navigation-top">
        ...
        <div class="page-content">
            ...
            ?>
                                ...
                                <div class="col-md-2 graphical monthly barmonth splinemonth4 piemonth dougnutmonth quarterly barquarter splinequarter piequarter dougnutquarter yearly baryear splineyear pieyear dougnutyear stackedareamonth3 colmonth3 splinemonth3 colpatientage  reporttype">
                                    <div class="form-group">
                                        <select class="form-control select" data-style="btn-primary" id="select-report" name="filterbutton">
                                            <option value="monthly" selected="selected" disabled="disabled">Select Report</option>
                                ...
                                <!--Tabular-->
                                <div class="col-md-2 tabular 1monthly 1quarterly 1yearly 1colpatientage reporttype">
                                    <div class="form-group">
                                        <select class="form-control select" data-style="btn-primary" id="select-report" name="filterbutton">
                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="graphical monthly barmonth splinemonth4 piemonth dougnutmonth quarterly barquarter splinequarter piequarter dougnutquarter yearly baryear splineyear pieyear dougnutyear stackedareamonth3 colmonth3 splinemonth3 colpatientage  reporttype">
                                            <?php
                                            ...
                                            ?>
                                            <hr>
                                            <h4>Total Referral Prenatal for the Year <?php echo $year. ' : <strong> ' .$fetch['total'].' Patients</strong>'?></h4> <hr>
