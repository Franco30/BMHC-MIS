...
<meta name="theme-color" content="#E91E63" />
    ...
    <?php require 'js/loadcharts/reports/familyplanning.php'?>
    <style type="text/css">
        @media print {
/*
            @page {
...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb print">
                ...
                <li class="active"><strong><mark>Family Planning Report</mark></strong></li>
            </ul>
            <!-- END BREADCRUMB -->
                                                ...
                                                <div class="panel-body panel-body-table">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    require 'chartqueries/familyplanning.php';
                                                                ?>
                                                                <tr>
    ...
    <script type="text/javascript" src="functions/familyplanning_daterange.js"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#pyear").on('change', function() {
                var year = $(this).val();
                window.location = 'familyplanning_reports?year=' + year;
            });
        });
    ...
    <script>
        function openTabular() {
            window.open("familyplanning_filter");
        }
    ...
    <!-- END TEMPLATE -->
    <!-- END SCRIPTS -->
    <?php require 'reports/tabular_familyplanning.php'?>
</body>
