...
<head>
    ...
    <?php require 'js/loadcharts/reports/familyplanning2.php'?>
    <?php require 'js/loadcharts/reports/familyplanning3.php'?>
    <!-- EOF CSS INCLUDE -->
    <style type="text/css">
        @media print {
/*
    ...
    <div class="page-container page-navigation-top">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb print">
                ...
                <li>Family Planning Reports</li>
                <li class="active"><mark><strong>Family Planning Filtered Reports</strong></mark></li>
            </ul>
            <!-- END BREADCRUMB -->
...
?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <select class="form-control select" data-style="btn-primary" id="select-report" name="filterbutton">
                                            ...
                                            <option value="colpatientmethod">Patient Method</option>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <!-- Patient Method Report Month-->
                                    <div class="form-group stackedareamonth3 stackedcolumn3 splinemonth3 colpatientmethod reporttype">
                                        <select style="display: none;" class="form-control select" data-style="btn-primary" name="filterbutton">
                                            <option value="colpatientmethod" selected="selected" disabled="disabled">Select Chart</option>
                                            <option value="colpatientmethod">Column Chart</option>
                                            <option value="stackedcolumn3">Stacked Column Chart</option>
                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <!-- Patient Method Report Month-->
                                        <div id="chartContainer6" class="colpatientmethod reporttype" style="width: 100%; height: 300px"></div>
                                        <div id="chartContainer6.1" class="stackedcolumn3 reporttype" style="width: 100%; height: 300px"></div>
                                        <div id="chartContainer6.2" class="splinemonth3 reporttype" style="width: 100%; height: 300px"></div>
                                        ...
                                        <?php require 'reports/familyplanning_monthly.php'?>
                                        <?php require 'reports/familyplanning_quarter.php'?>
    ...
    <script>
        $(document).ready(function() {
            $("#pyear").on('change', function() {
                var year = $(this).val();
                window.location = 'familyplanning_filter?year=' + year;
            });
        });
