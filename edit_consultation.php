    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                $query2 = $conn->query("SELECT * FROM `consultation` WHERE `patient_id` = '$_GET[patient_id]' && `consultation_id` = '$_GET[consultation_id]'") or die(mysqli_error());
                $fetch2 = $query2->fetch_array();
                date_default_timezone_set('Asia/Manila');
                $date=date("F j, Y");
                    ?>
                <li>Transactions</li>
                <li>Edit Consultation</li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Edit Consultation</strong></h3>
                                <div class="btn-group pull-right">
                                    <div class="pull-left">
                                        <button type="button" class="updateconsultation btn btn-success" value="<?php echo $fetch2['consultation_id']; ?>">Save</button>
                                        <a class="btn btn-danger" href="patient_consultation?patient_id=<?php echo $fetch['patient_id']; ?>">Cancel</a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div id="step-1">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-3">
                                                                <div class="form-group" style="margin-left:-10px;">
                                                                    <label>Weight</label>
                                                                    <input type="number" class="form-control" id="weight<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['weight']; ?>" placeholder="kgs." required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group" style="margin-left:-10px;">
                                                                    <label>Height</label>
                                                                    <input type="number" class="form-control" id="height<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['height']; ?>" placeholder="cm." required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group" style="margin-left:-10px;">
                                                                    <label>BP</label>
                                                                    <input type="text" class="mask_bp form-control" id="bp<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['bp']; ?>" name="bp" placeholder="mmHg" required />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group" style="margin-left:-10px;margin-right:-10px;">
                                                                    ...
                                                                    <input type="text" class="mask_temp form-control" id="temp<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['temp']; ?>" placeholder="°C" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="headfamily<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['head_of_the_family']; ?>" placeholder="Enter Head of the Family" required />
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="margin-left:-10px;">
                                                                    <label>Respiratory Rate - RR</label>
                                                                    <input type="number" class="form-control" id="rr<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['rr']; ?>" placeholder="bpm" required />
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="margin-right:-10px;">
                                                                    ...
                                                                    <input type="number" class="form-control" id="pr<?php echo $fetch2['consultation_id']; ?>" value="<?php echo $fetch2['rr']; ?>" placeholder="cpm" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
-->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" spellcheck="false" id="pefindings<?php echo $fetch2['consultation_id']; ?>"><?php echo $fetch2['pe_findings']; ?></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" spellcheck="false" id="diagnosis<?php echo $fetch2['consultation_id']; ?>"><?php echo $fetch2['diagnosis']; ?></textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" spellcheck="false" id="labrequest<?php echo $fetch2['consultation_id']; ?>"><?php echo $fetch2['lab_request']; ?></textarea>
                                                        </div>
