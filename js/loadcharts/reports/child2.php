...
<script type="text/javascript"> 
    $(document).ready(function(){ 
        ...
        var chart1 = new CanvasJS.Chart("chartContainer1",{
            ...
            subtitles:[
                {
                    text: "Monthly Child Patient Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
        ...
        var chart2 = new CanvasJS.Chart("chartContainer2",{
            ...
            animationEnabled: true,
            animationDuration: 1000,
            exportFileName: "Quarterly Child Patient Count - BMHC", 
            exportEnabled: true,
            toolTip: {
                shared: true  
            },
            ...
            subtitles:[
                {
                    text: "Quarterly Child Patient Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
        ...
        var chart3 = new CanvasJS.Chart("chartContainer3",{
            ...
            animationDuration: 1000,
            colorSet: "customColorSet",
            exportFileName: "Yearly Child Patient Count - BMHC", 
            exportEnabled: true,
            toolTip: {
                shared: true  
            },
            ...
            subtitles:[
                {
                    text: "Yearly Child Patient Count <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
