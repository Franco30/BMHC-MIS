<?php require 'chartqueries/patient.php'?>
<?php require 'chartqueries/patient_quarterly.php'?>
<?php require 'chartqueries/patient_purok.php'?>
<script type="text/javascript"> 
    $(document).ready(function(){ 
        ...
        exportFileName: "Children and Adult Patient Count - BMHC", 
        exportEnabled: true,
        toolTip: {
            shared: true  
        },
        ...
        subtitles:[
            {
                text: "Male and Female Patient - Year <?php echo $year?>"
            }
        ],
        legend: {
            cursor: "pointer",
