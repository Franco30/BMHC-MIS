...
<script type="text/javascript"> 
    $(document).ready(function(){ 
        ...
        var chart1 = new CanvasJS.Chart("chartContainer1",{
            ...
            subtitles:[
                {
                    text: "Consultation Monthly Patient Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
        ...
        var chart2 = new CanvasJS.Chart("chartContainer2",{
            ...
            subtitles:[
                {
                    text: "Consultation Quarterly Patient Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
        ...
        var chart3 = new CanvasJS.Chart("chartContainer3",{
            ...
            animationDuration: 1000,
            colorSet: "customColorSet",
            exportFileName: "Consultation Yearly Patient Count - BMHC", 
            exportEnabled: true,
            toolTip: {
                shared: true  
            },
            ...
            subtitles:[
                {
                    text: "Consultation Yearly Patient Count <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
