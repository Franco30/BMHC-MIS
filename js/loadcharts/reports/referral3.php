...
<script type="text/javascript"> 
    $(document).ready(function(){ 
        ...
        exportFileName: "Children and Adult Referral Count - BMHC", 
        exportEnabled: true,
        toolTip: {
            shared: true  
        },
        ...
        subtitles:[
            {
                text: "Children and Adult Referral Count - Year <?php echo $year?>"
            }
        ],
        legend: {
            cursor: "pointer",
        ...
        exportFileName: "Male and Female Referral - BMHC", 
        exportEnabled: true,
        toolTip: {
            shared: true  
        },
        ...
        subtitles:[
            {
                text: "Male and Female Referral - Year <?php echo $year?>"
            }
        ],
        legend: {
            cursor: "pointer",
