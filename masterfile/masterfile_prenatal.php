<div class="table-responsive">
    <table id="prenatal" class="table table-hover table-bordered">
        <thead>
            <tr class="warning">
...
$query = $conn->query("SELECT * FROM `prenatal` WHERE `prenatal`.`patient_id` =  '$_GET[patient_id]'") or die(mysqli_error());
while($fetch = $query->fetch_array()){
    ...
    ?>
            <tr>
                ...
                <td class="print">
                    <center><a href="prenatal_record2?patient_id=<?php echo $f['patient_id'];?>&&prenatal_id=<?php echo $prenatal_id?>" class="btn btn-md btn-default">All Records <span class="badge"><?php echo $f2['total']?></span></a></center>
                </td>
            </tr>
        <?php
        }
