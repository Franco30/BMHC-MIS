...
$query = $conn->query("SELECT * FROM `family_planning`, `patient` WHERE `patient`.`patient_id` =  '$_GET[patient_id]' && `family_planning`.`patient_id` = '$_GET[patient_id]' && `family_planning_id` = '$_GET[family_planning_id]'") or die(mysqli_error());
...
<?php
require 'require/config.php';
$query = $conn->query("SELECT * FROM `fp_follow_up` WHERE `patient_id` = '$_GET[patient_id]' order by `patient_id` DESC") or die(mysqli_error());
while($fetch = $query->fetch_array()){
?>		
							<tr>
...
?>				&nbsp;
				...
				<table id="table" class="table table-hover table-bordered">
					...
					<tr>
						<td><center><strong>Client Name</strong></center></td>
