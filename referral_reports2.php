...
<meta name="theme-color" content="#E91E63" />
    ...
    <?php require 'js/loadcharts/reports/referral.php'?>
    <style type="text/css">
        @media print {
/*
            @page {
...
<body>
    ...
    <div class="page-container page-navigation-top-fixed">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb print">
                ...
                <li class="active"><strong><mark>Referral Report</mark></strong></li>
            </ul>
            <!-- END BREADCRUMB -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default tabs">
                            <ul class="nav nav-tabs print" role="tablist">
                                <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Referral Tabular Report</a></li>
                                <li><a href="#tab-second" role="tab" data-toggle="tab">Referral Date Range tabular Report</a></li>
                            </ul>
                                    ...
                                    <div class="row">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Referral Tabular Report</strong></h3>
                                            </div>
                                                ...
                                                <div class="panel-body panel-body-table">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    require 'chartqueries/referral.php';
                                                                ?>
                                                                <tr>
                            ...
                            <div class="tab-pane" id="tab-second">
                                    <div class="row">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Referral Date Range Tabular Report</strong></h3>
                                                <div class="btn-group pull-right">
                                                    <div class="form-inline">
                                                        ...
                                                        <button style="margin-left: 6px;" type="button" class="btn btn-success print" id="btn_search"><span class="glyphicon glyphicon-search" style="margin-right: 0px;"></span></button> <button type="button" id="reset" class="btn btn-info print"><span class="glyphicon glyphicon-refresh" style="margin-right: 0px;"><span></span></span></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div id="patient_daterange">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody id="load_data">
                                                                    <?php
                                            $query = $conn->query("SELECT * FROM `referral` order by `referral_id` DESC LIMIT 16") or die(mysqli_error());
    ...
    <script type="text/javascript" src="functions/referral_daterange.js"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#pyear").on('change', function() {
                var year = $(this).val();
                window.location = 'referral_reports2?year=' + year;
            });
        });
    ...
    <!-- END TEMPLATE -->
    <!-- END SCRIPTS -->
    <?php require 'reports/tabular_referral.php'?>
</body>
