        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                $date=date("F j, Y");
                    ?>
                <li>Transactions</li>
                <li>Prenatal Referral Record</li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Prenatal Referral Record</strong></h3>
                                <div class="btn-group pull-right">
                                    <div class="pull-left">
                                        <a class="btn btn-default" href="referral"><span class="fa fa-undo"></span> Back</a>
                                        <a href="prenatal_referral_print.php?referral_id=<?php echo $fetch['referral_id']?>" class="btn btn-info"><span class="glyphicon glyphicon-print"></span> Preview</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                            ...
                                            <div class="panel panel-primary">
                                                <div class="panel-footer">
                                                    <h3 class="panel-title"><strong>Weeks AOG via UTZ and Complaints</strong></h3>
                                                </div>
								...
								while($fetch = $query->fetch_array()){
									?>
                                                                <tr>
                                                                    <td class="warning">
                                                                        <center><strong>Gravida</strong></center>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <center><?php echo $fetch['para']?></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="warning">
                                                                    ...
                                                                    <td>
                                                                        <center><?php echo $fetch['fhb']?></center>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="warning">
                                                                    ...
                                                                    <td>
                                                                        <center><?php echo $fetch['given']?></center>
                                                                    </td>
                                                                </tr>
                                                                <?php
												}
