                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default tabs">
                            <ul class="nav nav-tabs print" role="tablist">
                                <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Referral Prenatal Tabular Report</a></li>
                                <li><a href="#tab-second" role="tab" data-toggle="tab">Referral Prenatal Date Range tabular Report</a></li>
                            </ul>
                                    ...
                                    <div class="row">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Referral Prenatal Tabular Report</strong></h3>
                                            </div>
                            ...
                            <div class="tab-pane" id="tab-second">
                                    <div class="row">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong>Referral Prenatal Date Range Tabular Report</strong></h3>
                                                <div class="btn-group pull-right">
