...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function () {
    ...
    handlePageContentView = function () {
        ...
        t >= 3 && t < 4 ? (e = "hide", a = "in") : t >= 4 && t < 5 && (e = "d-none", a = "show"), $(window).on("load", function () {
    ...
    handlePanelAction = function () {
        ...
        panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (e) {
            ...
            a >= 4 && a < 5 ? $(this).tooltip("dispose") : $(this).tooltip("destroy"), $(this).closest(".panel").remove()
    ...
    handleScrollToTopButton = function () {
        ...
        var e = handleCheckBootstrapVersion(),
            a = "";
        e >= 3 && e < 4 ? a = "in" : e >= 4 && e < 5 && (a = "show"), $(document).scroll(function () {
    ...
    handleThemePageStructureControl = function () {
        ...
        if ($(document).on("change", ".theme-panel [name=direction]", function () {
                2 == $(this).val() ? ($("body").addClass("rtl-mode"), Cookies.set("direction", $(this).val())) : ($("body").removeClass("rtl-mode"), Cookies.set("direction", $(this).val()))
        ...
        function a() {
            $(".tab-overflow").each(function () {
                ! function (e, a) {
                    ...
                    o != l && l >= i ? $(e).addClass("overflow-right") : $(e).removeClass("overflow-right"), o >= i && l >= i ? $(e).addClass("overflow-left") : $(e).removeClass("overflow-left")
                }(this, 0)
            })
        }
    ...
    handleUnlimitedTopMenuRender = function () {
        ...
        function a() {
            ...
            s != l && l >= o ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"), s >= o && l >= o ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
        }
    ...
    App = function () {
        ...
        return {
            ...
            initSidebar: function () {
                handleSidebarMenu(), handleMobileSidebarToggle(), handleSidebarMinify(), handleSidebarMinifyFloatMenu(), handleToggleNavProfile(), handleToggleNavbarSearch(), (!e || e && !e.disableSidebarScrollMemory) && handleSidebarScrollMemory()
            },
            ...
            initComponent: function () {
                (!e || e && !e.disableDraggablePanel) && handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handlePageScrollClass()
            },
