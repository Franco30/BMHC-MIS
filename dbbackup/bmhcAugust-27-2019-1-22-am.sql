...
INSERT INTO db_backup VALUES("10","22","Export","August 26, 2019","8:54 pm","Successfully Exported Database"); 
...
CREATE TABLE `follow_up` (
  ...
  `patient_service` varchar(30) NOT NULL,
  `follow_up_date` varchar(30) NOT NULL,
  `remarks` varchar(50) NOT NULL,
  PRIMARY KEY (`follow_up_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

INSERT INTO follow_up VALUES("1","22","15","Family Planning","2019-08-30","Balik di "); 
...
INSERT INTO patient VALUES("15","Jesse Franco Latosa","20","Male","Rosario Heights, Bacolod City","1998-08-30","179","09061613101","Negros Occidental","Student","3334343","JFranco Latoza","43343434","Registered","Aug","2019"); 
...
INSERT INTO users VALUES("22","Diana Rose S. Laput","No License","Medical Officer","admin","STG3Wim4UAAAAAIX3525VGdasGfWty2w2N67dagjd033e22ae348aeb5660fc2140aec35850c4da997","1","August 27, 2019, 12:07 am","July 29, 2019","2:00 am"); 
