        ...
        <div class="page-content">
	       ...
	       require 'require/config.php';
			...
			$fetch3 = $query3->fetch_array();
					?>
                <li>Data Entry</li>
                <li><a href="patient_overview?id=<?php echo $fetch2['patient_id']?>&&patient_name=<?php echo $fetch2['patient_name']?>">Patient Master File</a></li>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <div class="btn-group pull-right">
                                    <div class="pull-left">
                                   <a href="patient_overview?id=<?php echo $fetch2['patient_id']?>&&patient_name=<?php echo $fetch2['patient_name']?>" class="btn btn-default">Back</a>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <?php require 'tables/prenatal_record2.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
