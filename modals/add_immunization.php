<div class="modal fade" id="add_immunization" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="immunizationform" method="POST">
                <div class="modal-body">
					...
					$query = $conn->query("SELECT * FROM `patient_child` WHERE `status` != 'Registered Immunization' ORDER BY `child_id` DESC") or die(mysqli_error());
