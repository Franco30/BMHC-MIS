<div class="modal fade" id="new_prenatal" tabindex="-1" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
					...
					while($fetch = $query->fetch_array()){
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="husband" placeholder="Enter Husband" required />
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-left:-10px;">
                                        <label>TT1</label>
                                        <input type="text" class="form-control" id="tt1" placeholder="Enter TT1" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-right:-10px;">
                                        <label>TT2</label>
                                        <input type="text" class="form-control" id="tt2" placeholder="Enter TT2" required />
                                    </div>
                                </div>
                            </div>
                            &nbsp;
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-left:-10px;">
                                        <label>TT3</label>
                                        <input type="text" class="form-control" id="tt3" placeholder="Enter TT3" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-right:-10px;">
                                        <label>TT4</label>
                                        <input type="text" class="form-control" id="tt4" placeholder="Enter TT4" required />
                                    </div>
                                </div>
                            </div>
                            &nbsp;
