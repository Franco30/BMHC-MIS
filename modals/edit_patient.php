                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-left:-10px;">
                                        ...
                                        <input id="birthdate<?php echo $fetch['patient_id']; ?>" type="text" class="form-control datepicker birthdate" value="<?php echo $fetch['birthdate']; ?>" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-right:-10px;">
                                        <label>Age</label>
                                        <input id="age<?php echo $fetch['patient_id']; ?>" type="number" class="form-control age" style="font-size:11px;font-weight:bold;color:black" value="<?php echo $fetch['age']; ?>" readonly />
                                    </div>
                                </div>
                            </div>
                            &nbsp;
