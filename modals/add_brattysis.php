<div class="modal fade" id="add_brattysis" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
                    ...
                    <fieldset>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Name</label>
                                 <input type="hidden" class="form-control" value="<?php echo $id?>" id="child_id" required />
